...
<main>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="hot-deals container">
        <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Ưu Đãi Nóng</h2>
        <div class="row">
          <div
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{route('shop.products.details',['product_slug'=>$sproduct->slug])}}">
                    ...
                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="{{route('shop.products.details',['product_slug'=>$sproduct->slug])}}">{{$sproduct->name}}</a></h6>
          ...
          <div class="col-md-6">
            <div class="category-banner__item border-radius-10 mb-5">
              ...
              <div class="category-banner__item-content">
                ...
                <a href="{{route('shop.index')}}" class="btn-link default-underline text-uppercase fw-medium">Mua Ngay</a>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="category-banner__item border-radius-10 mb-5">
              ...
              <div class="category-banner__item-content">
                <h3 class="mb-0">Trang Phục Thể Thao</h3>
                <a href="{{route('shop.index')}}" class="btn-link default-underline text-uppercase fw-medium">Mua Ngay</a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="{{route('shop.products.details',['product_slug'=>$fproduct->slug])}}">{{$fproduct->name}}</a></h6>
