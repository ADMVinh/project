            ...
            <div class="wg-box">
                ...
                @error('images') <sapn class="alert alert-danger text-center">{{$message}} @enderror 
                    ...
                    <div class="cols gap22">
                        <fieldset class="name">
                            <div class="body-title mb-10">Giá gốc (VND) <span class="tf-color-1">*</span></div>
                            <input class="mb-10 format-vnd" type="text" placeholder="Nhập giá gốc" name="regular_price_display" id="regular_price_display" tabindex="0" value="{{ number_format($product->regular_price, 0, ',', '.') }}" aria-required="true" required="">
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10 format-vnd" type="text" placeholder="Nhập giá bán" name="sale_price_display" id="sale_price_display" tabindex="0" value="{{ number_format($product->sale_price, 0, ',', '.') }}" aria-required="true" required="">
