                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <a href="{{route('admin.slides')}}" class="">
                                        ...
                                        <div class="text">Trang trình chiếu</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                            ...
                            <div class="header-left">
                                ...
                                <form class="form-search flex-grow">
                                    ...
                                    <div class="box-content-search" id="box-content-search">
                                        ...
                                        <ul class="">
                                            <li class="mb-14">
                                                <div class="body-title">Đặt sản phẩm</div>
                                            </li>
                                            <li class="mb-14">
                                                <div class="divider"></div>
                                            </li>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <div class="message-item item-4">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">Đơn hàng đang chờ xử lý:<span>ID 305830</span>
                                                        </div>
