        ...
        <div class="tab-pane fade show active" id="tab-item-login" role="tabpanel" aria-labelledby="login-tab">
          <div class="login-form">
            <form method="POST" action="{{route('login')}}" name="login-form" class="needs-validation" novalidate="">
              ...
              <div class="customer-option mt-4 d-flex justify-content-end">
                <a href="{{route('password.request')}}" class="btn-text js-show-register" style="margin-top: -10px; text-decoration: none; color: blue"
              ...
              <div class="customer-option mt-4 text-center">
                ...
                <a href="{{route('register')}}"  class="btn-text js-show-register" style="margin-top: -10px; text-decoration: none; "
                onmouseover="this.style.textDecoration='underline';" 
                onmouseout="this.style.textDecoration='none';" >Tạo tài khoản</a> 
              </div>
            </form>
          </div>
        </div>
