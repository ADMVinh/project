...
<main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
      ...
      <div class="shop-list flex-grow-1">
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Phụ nữ <br /><strong>PHỤ KIỆN</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Phụ kiện là cách tốt nhất để
                      làm mới diện mạo của bạn. Thêm một đường viền tiêu đề với kiểu dáng và màu sắc mới hoặc chọn những món đồ vượt thời gian.</h6>
                  </div>
                </div>
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Phụ nữ <br /><strong>ACCESSORIES</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Phụ kiện là cách tốt nhất để
                      làm mới diện mạo của bạn. Thêm một đường viền tiêu đề với kiểu dáng và màu sắc mới hoặc chọn những món đồ vượt thời gian.</h6>
                  </div>
                </div>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route('shop.products.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{asset('uploads/products')}}/{{$product->image}}" width="330"height="400" alt="{{$product->name}}" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      @foreach (explode(",",$product->images) as $gimg)

                        <a href="{{route('shop.products.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{asset('uploads/products')}}/{{$gimg}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                      @endforeach
                    </div>
                  </div>
        ...
        <div class = "flex items-center justify flex-wrap gap10 wgp-pagination">
